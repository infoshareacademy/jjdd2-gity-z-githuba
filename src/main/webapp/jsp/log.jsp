...
<form action="${pageContext.request.contextPath}/LogServlet">
    ...
    <td><input type="number" min="0" max="999" class="block" name="getbyrangemin" placeholder="Start" size="5"
               maxlength="5"></td>
    <td><input type="number" min="0" max="999" class="block" name="getbyrangemax" placeholder="Stop" size="5"
               maxlength="5"></td>
...
<form action="${pageContext.request.contextPath}/LogServlet">
    <td>
        <button class="btn btn-xs btn-danger block" type="submit"><i class="glyphicon glyphicon-floppy-remove">Delete
            All
            Logs</i></button>
    </td>
